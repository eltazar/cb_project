...
-(void) layoutSubviews {
    ...
    NSLog(@"x = %f, y = %f, w = %f, h = %f",_coloredBoxRect.origin.x,_coloredBoxRect.origin.y,_coloredBoxRect.size.width,_coloredBoxRect.size.height);
    CGRect frame = CGRectMake(15, -10, 320, 40);
