...
@interface DocumentoAreaController : UIViewController<WMHTTPAccessDelegate, UIActionSheetDelegate, UIPrintInteractionControllerDelegate, UIWebViewDelegate, MFMailComposeViewControllerDelegate>{
    @protected
    NSString *phone;
    NSString *mail;
    ErrorView *errorView;
